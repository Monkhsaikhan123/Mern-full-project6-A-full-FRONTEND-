...
const AddMenu = () => {
  ...
  return (
    <div className='w-full md:w-[870px] px-4 mx-auto'>
        <h1 className='text-2xl font-semibold my-4'>Upload A new <span className='text-green'>Menu Item</span></h1>
        {/* form here */}
        ...
        <div>
            <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <button className='bg-green text-white px-6'>Add Items<FaUtensils/></button>
            </form>
        </div>
    </div>
  )
